...
public class GetPath {
    ...
    public static Properties loadConfig() throws IOException {
        ...
        try (InputStream input = GetPath.class.getClassLoader().getResourceAsStream("config.properties")) {
            if (input == null) {
    ...
    public static String writeToFile(String content) {
        String result = "";
        String fileName = System.getProperty("user.dir") + "/bin/s2exercise.txt";
