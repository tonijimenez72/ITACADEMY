...
-- INSERT employees store1
INSERT INTO employees (name, surname, idcard, phone, role, store_id)
VALUES 
    ('Employee', 'One', '11111111A', '555111111', 'kitchen', 1),
    ('Employee', 'Two', '22222222B', '555222222', 'delivery', 1),
	
-- INSERT categories 
INSERT INTO categories (name) VALUES ('Vegan'), ('Ofer'), ('Chilli'), ('Familiar'), ('Regular'), ('Big');

-- INSERT products

INSERT INTO products (name, product, price, image, category_id)
VALUES ('Beer', 'drink', 3.00, 'https://www.pizza.com/img/beer.png', NULL),
       ('Water', 'drink', 1.50, 'https://www.pizza.com/img/water.png', NULL);
